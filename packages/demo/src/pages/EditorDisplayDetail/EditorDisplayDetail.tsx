...
import EditorDisplay from '@zaihui/hui-design/src/components/EditorDisplay'
...
const EditorDisplayDetail: React.FC = () => {
  ...
  const headerContent =
    '爆浆鸡排：色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口'
  const footerContent =
    '爆浆鸡排：色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口色泽金黄-酥脆可口'
  ...
  return (
    <View className='editor-display-detail'>
      {type === 'noContent' && (
        <EditorDisplay
          type='noContent'
          image='https://r.kezaihui.com/client/2022-03-10/editor_display_610.png'
        />
      )}
      {type === 'withContent' && (
        <EditorDisplay
