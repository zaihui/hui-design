...
import HuiSelect, { OptionValue, Level } from '@zaihui/hui-design/src/components/Select'
import PageHeader from '@/demoComponents/PageHeader'
import GroupSection from '@/demoComponents/GroupSection'
import HuiButton from '@zaihui/hui-design/src/components/Button/Button'
...
const data = [
  {
    ...
    children: [
      ...
      { label: '职业经理人', value: '职业经理人' },
      { label: '私营企业主', value: '私营企业主' },
      { label: '中层管理者', value: '中层管理者' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: '风控安全', value: '风控安全' },
      { label: '个体／网店', value: '个体／网店' },
    ],
  },
  {
    label: '文化传媒',
    value: '文化传媒',
    children: [
      { label: '编辑策划', value: '编辑策划' },
      { label: '记者', value: '记者' },
      { label: '艺人', value: '艺人' },
      { label: '经纪人', value: '经纪人' },
      { label: '媒体工作者', value: '媒体工作者' },
    ],
  },
  {
    label: '金融',
    ...
    children: [
      ...
      { label: '投行', value: '投行' },
      { label: '保险', value: '保险' },
      { label: '金融分析', value: '金融分析' },
      { label: '财务', value: '财务' },
      { label: '风险管理', value: '风险管理' },
      { label: '风险投资人', value: '风险投资人' },
    ],
  },
  {
    label: '教育培训',
  ...
  },
  {
    ...
    children: [
      { label: '医生', value: '医生' },
      { label: '护士', value: '护士' },
      { label: '宠物医生', value: '宠物医生' },
      { label: '医学研究', value: '医学研究' },
    ],
  },
  {
    label: '政府组织',
  ...
  },
  {
    ...
    children: [
      ...
      { label: '技工', value: '技工' },
      { label: '质检', value: '质检' },
      { label: '建筑工人', value: '建筑工人' },
      { label: '装修工人', value: '装修工人' },
      { label: '建筑设计师', value: '建筑设计师' },
    ],
  },
  {
    label: '餐饮出行',
    ...
    children: [
      ...
      { label: '导购', value: '导购' },
      { label: '保安', value: '保安' },
      { label: '乘务人员', value: '乘务人员' },
      { label: '驾驶员', value: '驾驶员' },
      { label: '航空人员', value: '航空人员' },
      { label: '空乘', value: '空乘' },
    ],
  },
  {
    ...
    children: [
      { label: '导游', value: '导游' },
      { label: '快递员（含外卖）', value: '快递员（含外卖）' },
      { label: '美容美发', value: '美容美发' },
      { label: '家政服务', value: '家政服务' },
      { label: '婚庆摄影', value: '婚庆摄影' },
    ...
    <View className='select-page'>
      ...
      <View className='content'>
        ...
        <GroupSection title='特殊场景'>
          <View className='row'>
            <HuiButton block type='secondary' onClick={() => setV3(true)}>
              模拟异步请求
            </HuiButton>
          </View>
          <View className='row'>
            <HuiButton block type='secondary' onClick={() => setV4(true)}>
              选项过少，容器高度不足
            </HuiButton>
          </View>
          <View className='row'>
            <HuiButton block type='secondary' onClick={() => setV5(true)}>
              多组时，每个分组选项高度不一致
            </HuiButton>
          </View>
        </GroupSection>
