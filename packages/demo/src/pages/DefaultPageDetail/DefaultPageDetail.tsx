...
import HuiDefaultPage from '@zaihui/hui-design/src/components/DefaultPage'
import HuiImage from '@zaihui/hui-design/src/components/Image'
...
const DefaultPageDetail: React.FC = () => {
  ...
  const { type = 'noData' } = JSON.parse(decodeURIComponent(q)) as {
