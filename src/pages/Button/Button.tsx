...
const ButtonItem: React.FC<ButtonItemProps> = (props) => {
  ...
  return (
    <View className='button-item'>
      ...
      <View className='btn-container'>{children}</View>
    </View>
  )
}
    ...
    <View className='content'>
      <GroupSection title='按钮类型'>
        <View className='button-list-container'>
          ...
          <ButtonItem title='次要按钮'>
            <HuiButton color='#ed3737' type='secondary'>
              次要按钮
            </HuiButton>
          </ButtonItem>
          <ButtonItem title='文字按钮'>
            <HuiButton color='#ed3737' type='text'>
              按钮文字
            </HuiButton>
          </ButtonItem>
          <ButtonItem title='主要渐变按钮'>
            <HuiButton
              type='primary'
              gradientColor='linear-gradient(134deg, #F48B59 0%, #ED3737 100%)'
            >
              按钮文字
            </HuiButton>
          </ButtonItem>
      ...
      <GroupSection title='次要按钮状态'>
        <View className='button-list-container'>
          ...
          <ButtonItem title='不可点击'>
            <HuiButton type='secondary' disabled>
              按钮文字
            </HuiButton>
          </ButtonItem>
          <ButtonItem title='加载中'>
            <HuiButton type='secondary' loading>
              按钮文字
            </HuiButton>
          </ButtonItem>
        </View>
      ...
      <GroupSection title='文字按钮状态'>
        <View className='button-list-container'>
          ...
          <ButtonItem title='不可点击'>
            <HuiButton type='text' disabled>
              按钮文字
            </HuiButton>
          </ButtonItem>
          <ButtonItem title='加载中'>
            <HuiButton type='text' loading>
              按钮文字
            </HuiButton>
          </ButtonItem>
        </View>
      ...
      <GroupSection title='自定义圆角/颜色'>
        <View className='button-list-container'>
          <ButtonItem title='主要按钮'>
            <HuiButton radiusType='square' color='#ff6c00'>
              按钮文字
            </HuiButton>
          </ButtonItem>
          <ButtonItem title='次要按钮'>
            <HuiButton type='secondary' radiusType='square' color='#ff6c00'>
              按钮文字
            </HuiButton>
          </ButtonItem>
        </View>
